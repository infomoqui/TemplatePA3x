		...
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					...
					$btn_output = ' <button class="button btn btn-primary" onclick="this.form.searchword.focus();"><span class="fa fa-search" aria-hidden="true"></span><span class="sr-only">' . $button_text . '</span></button>';
				endif;
